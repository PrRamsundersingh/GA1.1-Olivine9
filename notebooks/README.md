# GA1.1-Olivine9
Subteam A: Branched to make an add function. Call the "add" function along with two variables "a" and "b" and then print this to get the result, for example: print(add(2, 10))
## Subteam B:
